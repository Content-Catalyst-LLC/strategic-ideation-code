/*
Low-level heuristic score utilities.
Compile: cc heuristic_score.c -o heuristic_score
Run: ./heuristic_score
*/
...
double heuristic_profile(Context c) {
...
int main(void) {
    ...
    for (int i = 0; i < count; i++) {
        printf("%s | %.3f\n", contexts[i].id, heuristic_profile(contexts[i]));
    }
